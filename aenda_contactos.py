...
def agregar_contacto(agenda):
    ...
    telefono = int(input("Por favor introduzca el teléfono del contacto:"))
    email = input("Por favor introduzca el emaíl del contacto:")
...
def eliminar_contacto(agenda):
    ...
    if nombre in agenda:
        ...
        print(f"No se ha encotrado un contacto con el nombre{nombre}")
...
def buscar_contacto(agenda):
    ...
    if nombre in agenda:
        ...
        print(f"El contacto {nombre} mo ha sido encontrado en la agenda")
...
def agenda_contactos():
    ...
    while True: 
        ...
        if opcion == "1":
            ...
            print("Sececciona una opción válida (del 1 al 5)")
